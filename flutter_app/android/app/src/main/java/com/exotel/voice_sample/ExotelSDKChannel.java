                ...
                (call, result) -> {
                    ...
                    switch (call.method) {
                        ...
                        case "initialize":
                            ...
                            sharedPreferencesHelper.putString(ApplicationSharedPreferenceData.APP_HOSTNAME.toString(), mSDKHostName);
                            sharedPreferencesHelper.putString(ApplicationSharedPreferenceData.ACCOUNT_SID.toString(), mAccountSid);
                            sharedPreferencesHelper.putString(ApplicationSharedPreferenceData.USER_NAME.toString(), mUserName);
                            sharedPreferencesHelper.putString(ApplicationSharedPreferenceData.SUBSCRIBER_TOKEN.toString(), mSubsriberToken);
                            sharedPreferencesHelper.putString(ApplicationSharedPreferenceData.DISPLAY_NAME.toString(), mDisplayName);
                            break;
                        case "reset":
                            reset();
                        case "dial":
